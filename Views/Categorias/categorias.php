        ...
        <div>
            <h1><i class="fas fa-box-tissue"></i> <?= $data['page_title'] ?>
              <?php if($_SESSION['permisosMod']['w']){ ?>
                <button class="btn-bootstrap slideUp" type="button" onclick="openModal();" ><i class="fas fa-plus-circle"></i> Nuevo</button>
              <?php } ?> 
            </h1>
        </div>
              ...
              <div class="tile">
                <div class="tile-body">
                  <div class="table-responsive">
                    <table class="table table-bordered" id="tableCategorias">
                      <thead>
                        <tr class="btntable slideLeft" >
                          <th class="floater ">No.id</th>
                          <th class="floater">Nombre</th>
                          <th class="floater">Descripción</th>
