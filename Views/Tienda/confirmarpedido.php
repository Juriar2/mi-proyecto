...
<div class="jumbotron text-center">
  <h1 class="display-4">¡Gracias por tu compra en momento  mas recibira un email!</h1>
  <p class="lead">Tu pedido fue procesado con éxito.</p>
  <p>Su no. Orden: <strong> <?= $data['orden']; ?> </strong></p>
  	<?php 
   ...
   <?php } ?>
  <hr class="my-4">
  <p>Muy pronto estaremos en contacto para coordinar la entrega su paquete .</p>
